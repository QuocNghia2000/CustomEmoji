...
package com.custom.emoji.emojiicon;
...
import com.custom.emoji.R;
import com.custom.emoji.data.Emojicon;
import com.custom.emoji.data.Nature;
import com.custom.emoji.data.Objects;
import com.custom.emoji.data.People;
import com.custom.emoji.data.Places;
import com.custom.emoji.data.Symbols;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
	...
	public EmojiconsPopup(View rootView, Context mContext){
		...
		//default size 
		setSize((int) mContext.getResources().getDimension(R.dimen.keyboard_height), LayoutParams.WRAP_CONTENT);
	}
	/**
