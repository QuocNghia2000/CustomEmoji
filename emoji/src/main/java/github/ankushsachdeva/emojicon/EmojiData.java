...
public abstract class EmojiData {
    ...
    public abstract ArrayList<String> getDataRow0();
    public abstract ArrayList<String> getDataRow1();
    public abstract ArrayList<String> getDataRow2();
    public abstract ArrayList<String> getDataRow3();
    public abstract ArrayList<String> getDataRow4();
    public abstract ArrayList<String> getDataRow5();
    public abstract ArrayList<String> getDataRow6();
    public abstract ArrayList<String> getDataRow7();
